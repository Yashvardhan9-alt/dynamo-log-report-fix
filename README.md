...
- Rewrote `instruction.md` to clearly define the expected output.
...
This repository was created as part of a bug-fixing assessment. It documents the fixes made to improve task correctness, security, and verification quality.
